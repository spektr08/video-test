...
const { GaussianBlurBackgroundProcessor, VirtualBackgroundProcessor } = require( '@twilio/video-processors');
...
(async function() {
  ...
  const showLocalVideo = async (room, video) => {
    console.log('log showLocalVideo');
